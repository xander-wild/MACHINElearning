...
# we can change these prameteres according to diff disease and 
# can get a hypothtical data according to the pathogan 
# we have take a seniro of 4500 people 
# in which we have assumed tha 90% will get affected 
